 ...
 *
 * --json не проставляет `replacement` (правила знают, что не так, но не знают, как надо):
 * тексты замен дописываются руками, иначе у примера не будет кнопок «Apply this fix».
 */
